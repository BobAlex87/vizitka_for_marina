...
async def get_start(message: Message, bot: Bot):
    ...
    await message.answer_photo(
        ...
        caption=f'Привет {message.from_user.first_name}👋!'
                ...
                f'\nкак можно заработать на минимальных вложениях пассивный доход до 💵2047 $ в месяц'
                f'\n✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨ ✨'
                ...
                f'\n✅И тут этот вариант возможен а если хочешь большего, то все же поработать  и что-то поделать придется.'
                f'\n<b>Начнем!</b>',
...
async def get_help(message: Message, bot: Bot):
    ...
    await message.answer("👋Я бот-помошник, и моя задача предоставить тебе всю необходимую информацию, "
                         ...
                         "✅Выбери команду /start и воспользуйся кнопками под сообщением")
